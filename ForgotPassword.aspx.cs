    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyEShoppingDB"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/>http://localhost:49991/RecoverPassword.aspx" + myGUID;



                MailMessage PassRecMail = new MailMessage("shanimishrarizz@gmail", ToEmailAddress);

                PassRecMail.Body = EmailBody;
                PassRecMail.IsBodyHtml = true; PassRecMail.Body = EmailBody;
